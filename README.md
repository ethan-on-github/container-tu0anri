...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tu0anri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tu0anri.containers.anotherwebservice.com/
...
```
git clone git@github.com:ethan-on-github/container-tu0anri.git
cd container-tu0anri
```
...
```
docker attach container-tu0anri
```
